...
setup(
    ...
    description='A Python package for biological network generation and analysis.',
    install_requires=['matplotlib', 'numpy', 'pandas', 'networkx >= 2.5','stringdb','python-louvain','scipy >= 1.6.1'],
    python_requires='>=3',
    entry_points={
        'console_scripts': ['ppinet=ppinet.ppinet:main'],
    },
    url='https://github.com/lmigueel/ppinet/',
